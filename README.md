...
insert your own JWT secret in 

 - .yo-rc_template.json
 - config/application-dev_template.yml
 - config/application-heroku_template.yml
 - config/application-prod_template.yml

and remove the template in the name

also get your own client_secret.json from google to query the youtube api in 
/src/main/resources/client_secrets.json

for the rest follow the standard documentation
...
To optimize the hackSearch application for production, run:
