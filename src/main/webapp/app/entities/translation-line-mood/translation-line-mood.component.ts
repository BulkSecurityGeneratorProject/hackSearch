...
@Component({
    selector: 'jhi-translation-line-mood',
    templateUrl: './translation-line-mood.component.html'
})
export class TranslationLineMoodComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.translationLineService
            ...
            .subscribe(
                (res: HttpResponse<ITranslationLineMood[]>) => this.paginateTranslationLines(res.body, res.headers),
    ...
    trackId(index: number, item: ITranslationLineMood) {
        return item.id;
    }
